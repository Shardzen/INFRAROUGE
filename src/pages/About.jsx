...
const About = () => {
  ...
  return (
    <div className="bg-black min-h-screen pt-32 pb-40 overflow-hidden relative">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-4 sm:px-10 relative z-10">
        ...
        <div className="mb-24 sm:mb-32 space-y-6">
          <span className="text-infrared-red font-mono text-[10px] tracking-[0.8em] uppercase reveal-text">
            System_Origins_v1.0
          </span>
          ...
          <div className="lg:col-span-7 space-y-16">
            <div className="space-y-8">
              ...
              <p className="text-white text-2xl sm:text-4xl font-light leading-tight tracking-tight">
                ...
                <span className="text-infrared-red"> C'est exactement là que se situe l'underground.</span>
              </p>
            </div>
            ...
            <div className="p-8 sm:p-12 rounded-3xl bg-white/[0.02] border border-white/5 space-y-12 relative overflow-hidden group">
              ...
              <div className="space-y-8 relative z-10">
                <div className="space-y-2">
                  <div className="text-infrared-red font-mono text-[8px] uppercase tracking-widest">01 / Curations</div>
                ...
                <div className="space-y-2">
                  <div className="text-infrared-yellow font-mono text-[8px] uppercase tracking-widest">02 / Sonics</div>
                ...
                <div className="space-y-2">
                  <div className="text-infrared-blue font-mono text-[8px] uppercase tracking-widest">03 / Community</div>
        ...
        <div className="mt-40 text-center space-y-12">
          <h2 className="text-4xl sm:text-7xl font-display font-black text-white uppercase leading-none">
            Vous faites partie<br />du <span className="text-infrared-red">spectre</span> ?
          </h2>
