      ...
      >
        ...
        <div className="absolute inset-0 p-6 flex flex-col justify-between">
          <div className="flex justify-between items-start">
            ...
            <div className="w-10 h-10 flex items-center justify-center text-2xl text-infrared-hot">
        ...
        <div className="container mx-auto">
          <div className="mb-12 space-y-4">
            <div className="flex items-center gap-4">
              ...
              <h2 className="text-4xl md:text-5xl font-bold tracking-tighter font-display text-gradient flex items-center gap-3">
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto">
          ...
          <div className="text-center">
            <Link
              to="/artists"
              className="inline-block group relative px-8 py-4 border border-infrared-purple rounded-lg overflow-hidden hover:border-infrared-orange transition-all duration-300"
            >
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-4xl text-center space-y-8">
          <div className="relative inline-block">
            <h2 className="text-5xl md:text-6xl font-bold tracking-tighter font-display text-gradient">
