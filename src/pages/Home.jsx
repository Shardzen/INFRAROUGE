      ...
      >
        ...
        {artist.coverImage ? (
          <img
            ...
            alt={artist.name}
            className="parallax-img transition-all duration-1000 group-hover:scale-110 grayscale group-hover:grayscale-0 brightness-[0.7] group-hover:brightness-100"
        ...
        <div className="absolute inset-0 z-20 p-6 sm:p-8 flex flex-col justify-between">
          ...
          <div className="space-y-2 translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
            ...
            <div className="flex items-center gap-3">
              <div className="h-px w-4 bg-infrared-red" />
    ...
    <div className="relative bg-black">
        ...
        <div className="flex whitespace-nowrap animate-marquee">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="text-[8vw] font-display font-black text-white/[0.03] uppercase mx-10 flex items-center gap-10">
              ...
              <span className="text-infrared-red opacity-30">/</span>
              <span>Contemporain</span>
              <span className="text-infrared-yellow opacity-30">/</span>
              <span>Expérimental</span>
              <span className="text-infrared-blue opacity-30">/</span>
            </div>
          ))}
        </div>
      </div>
        ...
        <div className="container mx-auto">
          <div className="mb-20 flex flex-col sm:flex-row sm:items-end justify-between gap-8">
            <div className="space-y-4">
              <div className="flex items-center gap-4 text-infrared-red font-mono text-xs tracking-[0.5em] uppercase">
        ...
        <div className="container mx-auto">
          <div className="mb-20 flex flex-col sm:flex-row-reverse sm:items-end justify-between gap-8">
            <div className="space-y-4 sm:text-right">
              <div className="flex items-center sm:justify-end gap-4 text-infrared-blue font-mono text-xs tracking-[0.5em] uppercase">
                Selection_02
                <span className="w-8 h-px bg-current opacity-30" />
              </div>
              <h2 className="text-6xl sm:text-9xl font-display font-black tracking-tighter text-white uppercase leading-none">
      ...
      <section className="py-24 sm:py-40 px-4 sm:px-10">
        <div className="container mx-auto">
          <div className="mb-20 flex flex-col sm:flex-row sm:items-end justify-between gap-8">
            <div className="space-y-4">
              <div className="flex items-center gap-4 text-infrared-yellow font-mono text-xs tracking-[0.5em] uppercase">
                <span className="w-8 h-px bg-current opacity-30" />
                Capture_03
              </div>
              <h2 className="text-6xl sm:text-9xl font-display font-black tracking-tighter text-white uppercase leading-none">
      ...
      <section className="py-24 sm:py-40 px-4 sm:px-10 bg-white/[0.01]">
        <div className="container mx-auto">
          <div className="mb-20 flex flex-col sm:flex-row-reverse sm:items-end justify-between gap-8">
            <div className="space-y-4 sm:text-right">
              <div className="flex items-center sm:justify-end gap-4 text-infrared-red font-mono text-xs tracking-[0.5em] uppercase">
                Motion_04
                <span className="w-8 h-px bg-current opacity-30" />
              </div>
              <h2 className="text-6xl sm:text-9xl font-display font-black tracking-tighter text-white uppercase leading-none">
          ...
          <div className="flex flex-col lg:flex-row gap-24">
            <div className="lg:w-1/2 space-y-12">
              <div className="space-y-6">
                <h2 className="text-6xl sm:text-8xl font-display font-black tracking-tighter text-white uppercase leading-[0.8]">
                  Agenda<br /><span className="text-infrared-red">Live</span>
                </h2>
                ...
                {upcomingEvents.map((event) => (
                  <div key={event.id} className="group py-8 border-b border-white/5 flex items-center justify-between hover:bg-white/[0.01] px-4 transition-colors">
                    <div className="space-y-2">
                      <div className="font-mono text-[10px] text-infrared-yellow uppercase tracking-[0.2em]">
                        {new Date(event.date).toLocaleDateString('fr-FR', { day: 'numeric', month: 'short' })} — {event.location.split(',')[0]}
                      </div>
                      <h3 className="text-2xl sm:text-3xl font-display font-bold text-white group-hover:text-infrared-red transition-colors">
                        {event.title}
                      </h3>
                    </div>
                    <a href={event.ticketUrl} target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center hover:bg-infrared-red hover:border-infrared-red hover:text-black transition-all">
                      →
                    </a>
                  </div>
                ))}
            ...
            <div className="lg:w-1/2 flex items-center justify-center">
              <div className="relative w-full aspect-square max-w-md group">
                <div className="absolute inset-0 bg-infrared-red opacity-20 blur-[100px] group-hover:opacity-40 transition-opacity" />
      ...
      <section className="py-32 sm:py-48 px-4 sm:px-10">
        <div className="container mx-auto">
          <div className="relative rounded-3xl overflow-hidden bg-white/[0.02] border border-infrared-red/20 p-12 sm:p-24 text-center space-y-10">
            <div className="space-y-4">
              <div className="text-infrared-red font-mono text-[10px] tracking-[0.5em] uppercase">Recrutement_Ouvert</div>
